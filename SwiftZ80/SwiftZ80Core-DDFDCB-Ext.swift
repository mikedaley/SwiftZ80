...
extension SwiftZ80Core {
    ...
    mutating func lookupDDFDCBOpcode(opcode: Byte, address: Word) {
        ...
        case 0x00:		/* LD B,RLC (REGISTER+dd) */
            B = memoryReadAddress(tempaddr)
            contend_read_no_mreq(tempaddr, tStates: 1)
            RLC(&B)
            memoryWriteAddress(tempaddr, value: B)
            break
        case 0x01:		/* LD C,RLC (REGISTER+dd) */
            C = memoryReadAddress(tempaddr)
            contend_read_no_mreq(tempaddr, tStates: 1)
            RLC(&C)
            memoryWriteAddress(tempaddr, value: C)
            break
        case 0x02:		/* LD D,RLC (REGISTER+dd) */
            D = memoryReadAddress(tempaddr)
            contend_read_no_mreq(tempaddr, tStates: 1)
            RLC(&D)
            memoryWriteAddress(tempaddr, value: D)
            break
        case 0x03:		/* LD E,RLC (REGISTER+dd) */
            E=memoryReadAddress(tempaddr)
            contend_read_no_mreq(tempaddr, tStates: 1)
            RLC(&E)
            memoryWriteAddress(tempaddr, value: E)
            break
        case 0x04:		/* LD H,RLC (REGISTER+dd) */
            H=memoryReadAddress(tempaddr)
            contend_read_no_mreq(tempaddr, tStates: 1)
            RLC(&H)
            memoryWriteAddress(tempaddr, value: H)
            break
        case 0x05:		/* LD L,RLC (REGISTER+dd) */
            L=memoryReadAddress(tempaddr)
            contend_read_no_mreq(tempaddr, tStates: 1)
            RLC(&L)
            memoryWriteAddress(tempaddr, value: L)
            break
        case 0x06:		/* RLC (REGISTER+dd) */
            var bytetemp: Byte = memoryReadAddress(tempaddr)
            contend_read_no_mreq(tempaddr, tStates: 1)
            RLC(&bytetemp)
            memoryWriteAddress(tempaddr,value: bytetemp)
            break
        case 0x07:		/* LD A,RLC (REGISTER+dd) */
            A = memoryReadAddress(tempaddr)
            contend_read_no_mreq(tempaddr, tStates: 1)
            RLC(&A)
            memoryWriteAddress(tempaddr, value: A)
            break
        ...
        case 0x47:		/* BIT 0,(REGISTER+dd) */
            let bytetemp: Byte = memoryReadAddress(tempaddr)
            contend_read_no_mreq(tempaddr, tStates: 1)
        ...
        case 0x80:		/* LD B,RES 0,(REGISTER+dd) */
            B = memoryReadAddress(tempaddr) & 0xfe
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: B)
            break
        case 0x81:		/* LD C,RES 0,(REGISTER+dd) */
            C = memoryReadAddress(tempaddr) & 0xfe
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: C)
            break
        case 0x82:		/* LD D,RES 0,(REGISTER+dd) */
            D = memoryReadAddress(tempaddr) & 0xfe
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: D)
            break
        case 0x83:		/* LD E,RES 0,(REGISTER+dd) */
            E = memoryReadAddress(tempaddr) & 0xfe
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: E)
            break
        case 0x84:		/* LD H,RES 0,(REGISTER+dd) */
            H = memoryReadAddress(tempaddr) & 0xfe
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: H)
            break
        case 0x85:		/* LD L,RES 0,(REGISTER+dd) */
            L = memoryReadAddress(tempaddr) & 0xfe
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: L)
            break
        case 0x86:		/* RES 0,(REGISTER+dd) */
            let bytetemp: Byte = memoryReadAddress(tempaddr)
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: bytetemp & 0xfe)
            break
        case 0x87:		/* LD A,RES 0,(REGISTER+dd) */
            A = memoryReadAddress(tempaddr) & 0xfe
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: A)
            break
        case 0x88:		/* LD B,RES 1,(REGISTER+dd) */
            B = memoryReadAddress(tempaddr) & 0xfd
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: B)
            break
        case 0x89:		/* LD C,RES 1,(REGISTER+dd) */
            C = memoryReadAddress(tempaddr) & 0xfd
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: C)
            break
        case 0x8a:		/* LD D,RES 1,(REGISTER+dd) */
            D = memoryReadAddress(tempaddr) & 0xfd
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: D)
            break
        case 0x8b:		/* LD E,RES 1,(REGISTER+dd) */
            E = memoryReadAddress(tempaddr) & 0xfd
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: E)
            break
        case 0x8c:		/* LD H,RES 1,(REGISTER+dd) */
            H = memoryReadAddress(tempaddr) & 0xfd
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: H)
            break
        case 0x8d:		/* LD L,RES 1,(REGISTER+dd) */
            L = memoryReadAddress(tempaddr) & 0xfd
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: L)
            break
        case 0x8e:		/* RES 1,(REGISTER+dd) */
            let bytetemp: Byte = memoryReadAddress(tempaddr)
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: bytetemp & 0xfd)
            break
        case 0x8f:		/* LD A,RES 1,(REGISTER+dd) */
            A = memoryReadAddress(tempaddr) & 0xfd
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: A)
            break
        case 0x90:		/* LD B,RES 2,(REGISTER+dd) */
            B = memoryReadAddress(tempaddr) & 0xfb
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: B)
            break
        case 0x91:		/* LD C,RES 2,(REGISTER+dd) */
            C = memoryReadAddress(tempaddr) & 0xfb
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: C)
            break
        case 0x92:		/* LD D,RES 2,(REGISTER+dd) */
            D = memoryReadAddress(tempaddr) & 0xfb
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: D)
            break
        case 0x93:		/* LD E,RES 2,(REGISTER+dd) */
            E = memoryReadAddress(tempaddr) & 0xfb
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: E)
            break
        case 0x94:		/* LD H,RES 2,(REGISTER+dd) */
            H = memoryReadAddress(tempaddr) & 0xfb
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: H)
            break
        case 0x95:		/* LD L,RES 2,(REGISTER+dd) */
            L = memoryReadAddress(tempaddr) & 0xfb
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: L)
            break
        case 0x96:		/* RES 2,(REGISTER+dd) */
            let bytetemp: Byte = memoryReadAddress(tempaddr)
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: bytetemp & 0xfb)
            break
        case 0x97:		/* LD A,RES 2,(REGISTER+dd) */
            A = memoryReadAddress(tempaddr) & 0xfb
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: A)
            break
        case 0x98:		/* LD B,RES 3,(REGISTER+dd) */
            B = memoryReadAddress(tempaddr) & 0xf7
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: B)
            break
        case 0x99:		/* LD C,RES 3,(REGISTER+dd) */
            C = memoryReadAddress(tempaddr) & 0xf7
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: C)
            break
        case 0x9a:		/* LD D,RES 3,(REGISTER+dd) */
            D = memoryReadAddress(tempaddr) & 0xf7
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: D)
            break
        case 0x9b:		/* LD E,RES 3,(REGISTER+dd) */
            E = memoryReadAddress(tempaddr) & 0xf7
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: E)
            break
        case 0x9c:		/* LD H,RES 3,(REGISTER+dd) */
            H = memoryReadAddress(tempaddr) & 0xf7
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: H)
            break
        case 0x9d:		/* LD L,RES 3,(REGISTER+dd) */
            L = memoryReadAddress(tempaddr) & 0xf7
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: L)
            break
        case 0x9e:		/* RES 3,(REGISTER+dd) */
            let bytetemp: Byte = memoryReadAddress(tempaddr)
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: bytetemp & 0xf7)
            break
        case 0x9f:		/* LD A,RES 3,(REGISTER+dd) */
            A = memoryReadAddress(tempaddr) & 0xf7
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: A)
            break
        case 0xa0:		/* LD B,RES 4,(REGISTER+dd) */
            B = memoryReadAddress(tempaddr) & 0xef
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: B)
            break
        case 0xa1:		/* LD C,RES 4,(REGISTER+dd) */
            C = memoryReadAddress(tempaddr) & 0xef
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: C)
            break
        case 0xa2:		/* LD D,RES 4,(REGISTER+dd) */
            D = memoryReadAddress(tempaddr) & 0xef
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: D)
            break
        case 0xa3:		/* LD E,RES 4,(REGISTER+dd) */
            E = memoryReadAddress(tempaddr) & 0xef
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: E)
            break
        case 0xa4:		/* LD H,RES 4,(REGISTER+dd) */
            H = memoryReadAddress(tempaddr) & 0xef
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: H)
            break
        case 0xa5:		/* LD L,RES 4,(REGISTER+dd) */
            L = memoryReadAddress(tempaddr) & 0xef
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: L)
            break
        case 0xa6:		/* RES 4,(REGISTER+dd) */
            let bytetemp: Byte = memoryReadAddress(tempaddr)
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: bytetemp & 0xef)
            break
        case 0xa7:		/* LD A,RES 4,(REGISTER+dd) */
            A = memoryReadAddress(tempaddr) & 0xef
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: A)
            break
        case 0xa8:		/* LD B,RES 5,(REGISTER+dd) */
            B = memoryReadAddress(tempaddr) & 0xdf
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: B)
            break
        case 0xa9:		/* LD C,RES 5,(REGISTER+dd) */
            C = memoryReadAddress(tempaddr) & 0xdf
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: C)
            break
        case 0xaa:		/* LD D,RES 5,(REGISTER+dd) */
            D = memoryReadAddress(tempaddr) & 0xdf
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: D)
            break
        case 0xab:		/* LD E,RES 5,(REGISTER+dd) */
            E = memoryReadAddress(tempaddr) & 0xdf
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: E)
            break
        case 0xac:		/* LD H,RES 5,(REGISTER+dd) */
            H = memoryReadAddress(tempaddr) & 0xdf
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: H)
            break
        case 0xad:		/* LD L,RES 5,(REGISTER+dd) */
            L = memoryReadAddress(tempaddr) & 0xdf
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: L)
            break
        case 0xae:		/* RES 5,(REGISTER+dd) */
            let bytetemp: Byte = memoryReadAddress(tempaddr)
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: bytetemp & 0xdf)
            break
        case 0xaf:		/* LD A,RES 5,(REGISTER+dd) */
            A = memoryReadAddress(tempaddr) & 0xdf
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: A)
            break
        case 0xb0:		/* LD B,RES 6,(REGISTER+dd) */
            B = memoryReadAddress(tempaddr) & 0xbf
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: B)
            break
        case 0xb1:		/* LD C,RES 6,(REGISTER+dd) */
            C = memoryReadAddress(tempaddr) & 0xbf
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: C)
            break
        case 0xb2:		/* LD D,RES 6,(REGISTER+dd) */
            D = memoryReadAddress(tempaddr) & 0xbf
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: D)
            break
        case 0xb3:		/* LD E,RES 6,(REGISTER+dd) */
            E = memoryReadAddress(tempaddr) & 0xbf
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: E)
            break
        case 0xb4:		/* LD H,RES 6,(REGISTER+dd) */
            H = memoryReadAddress(tempaddr) & 0xbf
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: H)
            break
        case 0xb5:		/* LD L,RES 6,(REGISTER+dd) */
            L = memoryReadAddress(tempaddr) & 0xbf
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: L)
            break
        case 0xb6:		/* RES 6,(REGISTER+dd) */
            let bytetemp: Byte = memoryReadAddress(tempaddr)
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: bytetemp & 0xbf)
            break
        case 0xb7:		/* LD A,RES 6,(REGISTER+dd) */
            A = memoryReadAddress(tempaddr) & 0xbf
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: A)
            break
        case 0xb8:		/* LD B,RES 7,(REGISTER+dd) */
            B = memoryReadAddress(tempaddr) & 0x7f
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: B)
            break
        case 0xb9:		/* LD C,RES 7,(REGISTER+dd) */
            C = memoryReadAddress(tempaddr) & 0x7f
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: C)
            break
        case 0xba:		/* LD D,RES 7,(REGISTER+dd) */
            D = memoryReadAddress(tempaddr) & 0x7f
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: D)
            break
        case 0xbb:		/* LD E,RES 7,(REGISTER+dd) */
            E = memoryReadAddress(tempaddr) & 0x7f
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: E)
            break
        case 0xbc:		/* LD H,RES 7,(REGISTER+dd) */
            H = memoryReadAddress(tempaddr) & 0x7f
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: H)
            break
        case 0xbd:		/* LD L,RES 7,(REGISTER+dd) */
            L = memoryReadAddress(tempaddr) & 0x7f
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: L)
            break
        case 0xbe:		/* RES 7,(REGISTER+dd) */
            let bytetemp: Byte = memoryReadAddress(tempaddr)
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: bytetemp & 0x7f)
            break
        case 0xbf:		/* LD A,RES 7,(REGISTER+dd) */
            A = memoryReadAddress(tempaddr) & 0x7f
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: A)
            break
        case 0xc0:		/* LD B,SET 0,(REGISTER+dd) */
            B = memoryReadAddress(tempaddr) | 0x01
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: B)
            break
        case 0xc1:		/* LD C,SET 0,(REGISTER+dd) */
            C = memoryReadAddress(tempaddr) | 0x01
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: C)
            break
        case 0xc2:		/* LD D,SET 0,(REGISTER+dd) */
            D = memoryReadAddress(tempaddr) | 0x01
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: D)
            break
        case 0xc3:		/* LD E,SET 0,(REGISTER+dd) */
            E = memoryReadAddress(tempaddr) | 0x01
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: E)
            break
        case 0xc4:		/* LD H,SET 0,(REGISTER+dd) */
            H = memoryReadAddress(tempaddr) | 0x01
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: H)
            break
        case 0xc5:		/* LD L,SET 0,(REGISTER+dd) */
            L = memoryReadAddress(tempaddr) | 0x01
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: L)
            break
        case 0xc6:		/* SET 0,(REGISTER+dd) */
            let bytetemp: Byte = memoryReadAddress(tempaddr)
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: bytetemp & 0x01)
            break
        case 0xc7:		/* LD A,SET 0,(REGISTER+dd) */
            A = memoryReadAddress(tempaddr) | 0x01
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: A)
            break
        case 0xc8:		/* LD B,SET 1,(REGISTER+dd) */
            B = memoryReadAddress(tempaddr) | 0x02
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: B)
            break
        case 0xc9:		/* LD C,SET 1,(REGISTER+dd) */
            C = memoryReadAddress(tempaddr) | 0x02
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: C)
            break
        case 0xca:		/* LD D,SET 1,(REGISTER+dd) */
            D = memoryReadAddress(tempaddr) | 0x02
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: D)
            break
        case 0xcb:		/* LD E,SET 1,(REGISTER+dd) */
            E = memoryReadAddress(tempaddr) | 0x02
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: E)
            break
        case 0xcc:		/* LD H,SET 1,(REGISTER+dd) */
            H = memoryReadAddress(tempaddr) | 0x02
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: H)
            break
        case 0xcd:		/* LD L,SET 1,(REGISTER+dd) */
            L = memoryReadAddress(tempaddr) | 0x02
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: L)
            break
        case 0xce:		/* SET 1,(REGISTER+dd) */
            let bytetemp: Byte = memoryReadAddress(tempaddr)
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: bytetemp & 0x02)
            break
        case 0xcf:		/* LD A,SET 1,(REGISTER+dd) */
            A = memoryReadAddress(tempaddr) | 0x02
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: A)
            break
        case 0xd0:		/* LD B,SET 2,(REGISTER+dd) */
            B = memoryReadAddress(tempaddr) | 0x04
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: B)
            break
        case 0xd1:		/* LD C,SET 2,(REGISTER+dd) */
            C = memoryReadAddress(tempaddr) | 0x04
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: C)
            break
        case 0xd2:		/* LD D,SET 2,(REGISTER+dd) */
            D = memoryReadAddress(tempaddr) | 0x04
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: D)
            break
        case 0xd3:		/* LD E,SET 2,(REGISTER+dd) */
            E = memoryReadAddress(tempaddr) | 0x04
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: E)
            break
        case 0xd4:		/* LD H,SET 2,(REGISTER+dd) */
            H = memoryReadAddress(tempaddr) | 0x04
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: H)
            break
        case 0xd5:		/* LD L,SET 2,(REGISTER+dd) */
            L = memoryReadAddress(tempaddr) | 0x04
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: L)
            break
        case 0xd6:		/* SET 2,(REGISTER+dd) */
            let bytetemp: Byte = memoryReadAddress(tempaddr)
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: bytetemp & 0x04)
            break
        case 0xd7:		/* LD A,SET 2,(REGISTER+dd) */
            A = memoryReadAddress(tempaddr) | 0x04
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: A)
            break
        case 0xd8:		/* LD B,SET 3,(REGISTER+dd) */
            B = memoryReadAddress(tempaddr) | 0x08
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: B)
            break
        case 0xd9:		/* LD C,SET 3,(REGISTER+dd) */
            C = memoryReadAddress(tempaddr) | 0x08
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: C)
            break
        case 0xda:		/* LD D,SET 3,(REGISTER+dd) */
            D = memoryReadAddress(tempaddr) | 0x08
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: D)
            break
        case 0xdb:		/* LD E,SET 3,(REGISTER+dd) */
            E = memoryReadAddress(tempaddr) | 0x08
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: E)
            break
        case 0xdc:		/* LD H,SET 3,(REGISTER+dd) */
            H = memoryReadAddress(tempaddr) | 0x08
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: H)
            break
        case 0xdd:		/* LD L,SET 3,(REGISTER+dd) */
            L = memoryReadAddress(tempaddr) | 0x08
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: L)
            break
        case 0xde:		/* SET 3,(REGISTER+dd) */
            let bytetemp: Byte = memoryReadAddress(tempaddr)
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: bytetemp & 0x08)
            break
        case 0xdf:		/* LD A,SET 3,(REGISTER+dd) */
            A = memoryReadAddress(tempaddr) | 0x08
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: A)
            break
        case 0xe0:		/* LD B,SET 4,(REGISTER+dd) */
            B = memoryReadAddress(tempaddr) | 0x10
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: B)
            break
        case 0xe1:		/* LD C,SET 4,(REGISTER+dd) */
            C = memoryReadAddress(tempaddr) | 0x10
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: C)
            break
        case 0xe2:		/* LD D,SET 4,(REGISTER+dd) */
            D = memoryReadAddress(tempaddr) | 0x10
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: D)
            break
        case 0xe3:		/* LD E,SET 4,(REGISTER+dd) */
            E = memoryReadAddress(tempaddr) | 0x10
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: E)
            break
        case 0xe4:		/* LD H,SET 4,(REGISTER+dd) */
            H = memoryReadAddress(tempaddr) | 0x10
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: H)
            break
        case 0xe5:		/* LD L,SET 4,(REGISTER+dd) */
            L = memoryReadAddress(tempaddr) | 0x10
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: L)
            break
        case 0xe6:		/* SET 4,(REGISTER+dd) */
            let bytetemp: Byte = memoryReadAddress(tempaddr)
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: bytetemp & 0x10)
            break
        case 0xe7:		/* LD A,SET 4,(REGISTER+dd) */
            A = memoryReadAddress(tempaddr) | 0x10
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: A)
            break
        case 0xe8:		/* LD B,SET 5,(REGISTER+dd) */
            B = memoryReadAddress(tempaddr) | 0x20
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: B)
            break
        case 0xe9:		/* LD C,SET 5,(REGISTER+dd) */
            C = memoryReadAddress(tempaddr) | 0x20
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: C)
            break
        case 0xea:		/* LD D,SET 5,(REGISTER+dd) */
            D = memoryReadAddress(tempaddr) | 0x20
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: D)
            break
        case 0xeb:		/* LD E,SET 5,(REGISTER+dd) */
            E = memoryReadAddress(tempaddr) | 0x20
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: E)
            break
        case 0xec:		/* LD H,SET 5,(REGISTER+dd) */
            H = memoryReadAddress(tempaddr) | 0x20
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: H)
            break
        case 0xed:		/* LD L,SET 5,(REGISTER+dd) */
            L = memoryReadAddress(tempaddr) | 0x20
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: L)
            break
        case 0xee:		/* SET 5,(REGISTER+dd) */
            let bytetemp: Byte = memoryReadAddress(tempaddr)
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: bytetemp & 0x20)
            break
        case 0xef:		/* LD A,SET 5,(REGISTER+dd) */
            A = memoryReadAddress(tempaddr) | 0x20
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: A)
            break
        case 0xf0:		/* LD B,SET 6,(REGISTER+dd) */
            B = memoryReadAddress(tempaddr) | 0x40
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: B)
            break
        case 0xf1:		/* LD C,SET 6,(REGISTER+dd) */
            C = memoryReadAddress(tempaddr) | 0x40
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: C)
            break
        case 0xf2:		/* LD D,SET 6,(REGISTER+dd) */
            D = memoryReadAddress(tempaddr) | 0x40
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: D)
            break
        case 0xf3:		/* LD E,SET 6,(REGISTER+dd) */
            E = memoryReadAddress(tempaddr) | 0x40
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: E)
            break
        case 0xf4:		/* LD H,SET 6,(REGISTER+dd) */
            H = memoryReadAddress(tempaddr) | 0x40
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: H)
            break
        case 0xf5:		/* LD L,SET 6,(REGISTER+dd) */
            L = memoryReadAddress(tempaddr) | 0x40
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: L)
            break
        case 0xf6:		/* SET 6,(REGISTER+dd) */
            let bytetemp: Byte = memoryReadAddress(tempaddr)
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: bytetemp & 0x40)
            break
        case 0xf7:		/* LD A,SET 6,(REGISTER+dd) */
            A = memoryReadAddress(tempaddr) | 0x40
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: A)
            break
        case 0xf8:		/* LD B,SET 7,(REGISTER+dd) */
            B = memoryReadAddress(tempaddr) | 0x80
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: B)
            break
        case 0xf9:		/* LD C,SET 7,(REGISTER+dd) */
            C = memoryReadAddress(tempaddr) | 0x80
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: C)
            break
        case 0xfa:		/* LD D,SET 7,(REGISTER+dd) */
            D = memoryReadAddress(tempaddr) | 0x80
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: D)
            break
        case 0xfb:		/* LD E,SET 7,(REGISTER+dd) */
            E = memoryReadAddress(tempaddr) | 0x80
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: E)
            break
        case 0xfc:		/* LD H,SET 7,(REGISTER+dd) */
            H = memoryReadAddress(tempaddr) | 0x80
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: H)
            break
        case 0xfd:		/* LD L,SET 7,(REGISTER+dd) */
            L = memoryReadAddress(tempaddr) | 0x80
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: L)
            break
        case 0xfe:		/* SET 7,(REGISTER+dd) */
            let bytetemp: Byte = memoryReadAddress(tempaddr)
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: bytetemp & 0x80)
            break
        case 0xff:		/* LD A,SET 7,(REGISTER+dd) */
            A = memoryReadAddress(tempaddr) | 0x80
            contend_read_no_mreq(tempaddr, tStates: 1)
            memoryWriteAddress(tempaddr, value: A)
            break
